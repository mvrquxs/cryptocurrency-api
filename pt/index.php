...
<body>
        ...
        <div class="navbar">
            ...
            <div class="nav-useful">
                <div class="language">
                    ...
                    <span>PT</span>
                    <a class="lang-switch" href="../en"><i class="fa-solid fa-shuffle"></i></a>
                </div>
    ...
    <section class="spix-main">
        <div class="s-title">
            <h2>Use a melhor API grátis de Criptomoedas</h2>
        </div>
        <div class="s-desc">
            <p>Obtenha resultados reais com vários parâmetros em tempo real sem limitações. Prestamos serviços sem autenticação!</p>
        </div>
        <div class="s-started">
            <button onclick="window.location.href='docs'">Iniciar agora</button>
        </div>
    </section>
